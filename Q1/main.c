...
int main(void)
{
    ...
    //inclusão de alunos pelo usuário
    ...
    /*
    => Pos - responsável para que tudo aconteça, comparações e modificações
    => Pos recebe o valor do topo da pilha -1, pois pilha[topo] ou possui nada ou possui "lixo"
    */
    int pos = minhaPilha.topo-1;
   /*
    if dentro do for - para a primeira opção, pois não precisaria usar
   variável auxiliar. para a outra opção, há a inclusão da variável na
   pilha auxiliar e a remoção dela na minhaPilha
   */
